...
const pb_field_t read_disk_request_fields[4] = {
...
const pb_field_t read_disk_response_fields[4] = {
    PB_FIELD(  1, MESSAGE , REQUIRED, STATIC  , FIRST, read_disk_response, header, header, &response_header_fields),
    PB_FIELD(  2, INT64   , REQUIRED, STATIC  , OTHER, read_disk_response, bytes_read, header, 0),
    PB_FIELD(  3, BYTES   , REQUIRED, STATIC  , OTHER, read_disk_response, data, bytes_read, 0),
    PB_LAST_FIELD
};
